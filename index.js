...
function animaster(){
    ...
    function moveAndHide(element, duration){
        ...
        let anim = animaster().addMove(duration*0.4,{x: 100, y: 20}).addFadeOut(duration*0.6).play(element);
        return{
            reset(){
                anim.reset();
            }
        ...
        _steps.forEach((operation)=>{
            switch (operation.name){
                ...
                case 'delay':
                    ...
                    break;
                case 'outlineWidth':
                    setTimeout(() => {outlineWidth(element,operation.duration, operation.arg)}, timeout);
                    timeout += operation.duration;
                    break;
            }
        })
    ...
    return {_steps, fadeIn, fadeOut, scale, move, moveAndHide, showAndHide, heartBeating, 
